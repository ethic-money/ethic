...
* Publicly identified, experienced founders
* Rewards every crucial member of the ecosystem
* No pre-mine or robbable developer pool - Developer funds generated along the way
* Governance prioritized, easy and deterministic
* Protection from "rug-pulls" and code errors
...
* Programmatically aligns the current value of ETHC towards an economic standard (currently the US Dollar but changable through governance)
