...
const INITIAL_STAKE_MULTIPLE = new BN(10).pow(new BN(6)); // 100 ETHC -> 100M ETHCS
...
describe('Bonding', function () {
  ...
  beforeEach(async function () {
    ...
    this.ethic = await Ethic.at(await this.bonding.ethic());
  ...
  describe('frozen', function () {
    ...
    describe('when deposit', function () {
      beforeEach(async function () {
        ...
        await this.ethic.approve(this.bonding.address, 1000, {from: userAddress});
      ...
      it('updates dao balances', async function () {
        expect(await this.ethic.balanceOf(this.bonding.address)).to.be.bignumber.equal(new BN(1000));
    ...
    describe('when withdraw', function () {
      ...
      it('updates dao balances', async function () {
        expect(await this.ethic.balanceOf(this.bonding.address)).to.be.bignumber.equal(new BN(0));
        expect(await this.bonding.totalSupply()).to.be.bignumber.equal(new BN(0));
        expect(await this.bonding.totalBonded()).to.be.bignumber.equal(new BN(0));
    ...
    describe('when withdraw too much', function () {
      beforeEach(async function () {
        ...
        await this.ethic.approve(this.bonding.address, 10000, {from: userAddress1});
    ...
    describe('when bond', function () {
      ...
      describe('partial', function () {
        ...
        it('updates dao balances', async function () {
          expect(await this.ethic.balanceOf(this.bonding.address)).to.be.bignumber.equal(new BN(800));
      ...
      describe('multiple', function () {
        beforeEach(async function () {
          ...
          await this.ethic.approve(this.bonding.address, 1000, {from: userAddress1});
          await this.bonding.deposit(1000, {from: userAddress1});

          await this.bonding.mintToE(userAddress2, 1000);
          await this.ethic.approve(this.bonding.address, 1000, {from: userAddress2});
          ...
          await this.bonding.mintToE(userAddress, 1000);
          await this.ethic.approve(this.bonding.address, 800, {from: userAddress});
          await this.bonding.deposit(800, {from: userAddress});
        ...
        it('updates dao balances', async function () {
          expect(await this.ethic.balanceOf(this.bonding.address)).to.be.bignumber.equal(new BN(3800));
    ...
    describe('when unbond', function () {
      ...
      describe('multiple', function () {
        ...
        it('updates dao balances', async function () {
          expect(await this.ethic.balanceOf(this.bonding.address)).to.be.bignumber.equal(new BN(4000));
